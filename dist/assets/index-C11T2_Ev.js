(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={"/":`home`,"/about-us":`about`,"/products":`products`,"/blogs":`blogs`,"/contact-us":`contact`,"/privacy-policy":`privacy`,"/terms-of-service":`terms`,"/digitalproducts/landing":`digitalproductslanding`},t={"why-digital-products-are-the-future-of-online-shopping":1,"india-handcrafted-heritage-artisans-thriving-online":2,"eco-friendly-shopping-handcrafted-products-better-for-planet":3,"top-digital-products-every-professional-needs-2026":4,"story-behind-every-stitch-supporting-indian-artisans":5,"digital-vs-physical-products-which-to-buy-online":6},n={home:`/`,about:`/about-us`,products:`/products`,blogs:`/blogs`,contact:`/contact-us`,privacy:`/privacy-policy`,terms:`/terms-of-service`,digitalproductslanding:`/digitalproducts/landing`},r=[{id:1,slug:`why-digital-products-are-the-future-of-online-shopping`,title:`Why Digital Products Are the Future of Online Shopping`,category:`Digital Products`,date:`July 1, 2026`,excerpt:`Exploring the rise of digital products and why they represent the next wave of eCommerce growth in India.`,content:`
  ...
  `,document.getElementById(`backToBlogs`).addEventListener(`click`,()=>{history.pushState({page:`blogs`},``,`/blogs`),i()}),document.getElementById(`backToBlogsBottom`).addEventListener(`click`,()=>{history.pushState({page:`blogs`},``,`/blogs`),i()}),window.scrollTo({top:0,behavior:`smooth`})}var s={home:{title:`Reevanti Global | AI eBooks, Digital Products & Indian Handcrafted Artisan Goods`,desc:`Reevanti Global is an MSME-registered eCommerce brand specialising in AI-powered eBooks, Digital Products, and authentic Indian Handcrafted Artisan goods. Shop online, export globally.`},about:{title:`About Reevanti Global | MSME-Registered Indian Exporter – AI eBooks & Artisan Crafts`,desc:`Reevanti Global is an MSME-registered eCommerce company from Navi Mumbai, India — bridging AI-powered Digital Products with authentic Indian Handcrafted Artisan goods for domestic and international markets.`},products:{title:`Products | AI eBooks, Digital Tools & Indian Handcrafted Artisan Goods – Reevanti Global`,desc:`Shop Reevanti Global's two categories: AI-powered eBooks & Digital Products for professionals, creators & entrepreneurs; and authentic Indian Handcrafted Artisan goods for domestic buyers and global traders.`},blogs:{title:`Insights & Resources | AI, eBooks, Indian Handicrafts & eCommerce – Reevanti Global`,desc:`Expert articles on AI, Artificial Intelligence, eBooks, Digital Products, Indian Handicrafts, Artisan Crafts, MSME, export trade, and eCommerce trends from Reevanti Global.`},contact:{title:`Contact Reevanti Global | AI Digital Products & Indian Artisan Goods Enquiries`,desc:`Contact Reevanti Global for AI eBook enquiries, Indian Handcrafted Artisan product orders, export trade partnerships, or MSME collaboration. Reach us by email or WhatsApp.`},privacy:{title:`Privacy Policy | Reevanti Global`,desc:`Read the Reevanti Global Privacy Policy to understand how we collect, use, and protect your personal information.`},terms:{title:`Terms of Service | Reevanti Global`,desc:`Review the Terms of Service governing your use of Reevanti Global's website, products, and eCommerce services.`},digitalproductslanding:{title:`AI eBooks & Digital Products | PromptFlow Pro - Reevanti Global`,desc:`Shop 100+ professional AI prompt eBooks for Content, Marketing, Coding & Business. Works with ChatGPT, Claude & Gemini. Instant download from Reevanti Global.`}};function c(e,t,r){let i=s[e]||s.home,a=t||i.title,o=r||i.desc,c=`https://www.reevantiglobal.com`+(n[e]||`/`);document.title=a;let l=document.querySelector(`meta[name="description"]`);l&&l.setAttribute(`content`,o);let u=document.querySelector(`link[rel="canonical"]`);u||(u=document.createElement(`link`),u.setAttribute(`rel`,`canonical`),document.head.appendChild(u)),u.setAttribute(`href`,c);let d=(e,t,n=`property`)=>{let r=document.querySelector(`meta[${n}="${e}"]`);r||(r=document.createElement(`meta`),r.setAttribute(n,e),document.head.appendChild(r)),r.setAttribute(`content`,t)};d(`og:url`,c),d(`og:title`,a),d(`og:description`,o),d(`twitter:title`,a,`name`),d(`twitter:description`,o,`name`),typeof fbq==`function`&&fbq(`track`,`PageView`)}document.addEventListener(`DOMContentLoaded`,()=>{let r=document.querySelector(`.mobile-menu-toggle`),a=document.querySelector(`.nav-links`),s=document.querySelectorAll(`.page-section`);r.addEventListener(`click`,()=>{a.classList.toggle(`active`)});function l(e){s.forEach(e=>e.classList.remove(`active-section`));let t=document.getElementById(e);t&&t.classList.add(`active-section`),document.querySelectorAll(`a[data-page]`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-page`)===e)}),a.classList.remove(`active`),c(e),e===`blogs`&&i(),window.scrollTo({top:0,behavior:`smooth`})}function u(e){let t=n[e]||`/`;history.pushState({page:e},``,t),l(e)}document.querySelectorAll(`a[data-page]`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),u(e.getAttribute(`data-page`))})}),document.querySelectorAll(`button[data-target]`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),u(e.getAttribute(`data-target`))})}),window.addEventListener(`popstate`,t=>{let n=t.state?.page||e[window.location.pathname]||`home`;t.state?.blogId?(l(`blogs`),o(t.state.blogId)):l(n)});let d=window.location.pathname.split(`/`);if(d[1]===`blogs`&&d[2]){let e=t[d[2]];l(`blogs`),e&&o(e)}else{let t=e[window.location.pathname]||`home`;l(t),history.replaceState({page:t},``,window.location.pathname)}let f=document.getElementById(`contactForm`),p=document.getElementById(`formSuccess`);f&&f.addEventListener(`submit`,e=>{e.preventDefault();let t=f.querySelector(`button[type="submit"]`),n=t.innerText;t.innerText=`Sending...`,t.disabled=!0;let r={name:document.getElementById(`name`).value,email:document.getElementById(`email`).value,inquiryType:document.getElementById(`inquiryType`).value,message:document.getElementById(`message`).value,_subject:`New Inquiry from Reevanti Global Website`,_template:`table`};fetch(`https://formsubmit.co/ajax/contact@reevantiglobal.com`,{method:`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:JSON.stringify(r)}).then(e=>e.json()).then(()=>{f.reset(),t.innerText=n,t.disabled=!1,p.classList.remove(`hidden`),setTimeout(()=>p.classList.add(`hidden`),5e3)}).catch(()=>{t.innerText=n,t.disabled=!1,alert(`There was an error sending your message. Please try again later.`)})}),document.querySelectorAll(`.faq-question`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.toggle(`active`);let t=e.nextElementSibling;e.classList.contains(`active`)?t.style.maxHeight=t.scrollHeight+`px`:t.style.maxHeight=null})});function m(e){let t=parseInt(e.getAttribute(`data-target`),10),n=Math.ceil(t/(1500/16)),r=0,i=setInterval(()=>{r+=n,r>=t&&(r=t,clearInterval(i)),e.textContent=r},16)}let h=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.querySelectorAll(`.lp-stat-num`).forEach(m),h.unobserve(e.target))})},{threshold:.3});document.querySelectorAll(`.lp-stats-bar`).forEach(e=>h.observe(e)),document.querySelectorAll(`.lp-scroll-btn`).forEach(e=>{e.addEventListener(`click`,e=>{e.preventDefault();let t=document.getElementById(`lp-collection`);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})})})});